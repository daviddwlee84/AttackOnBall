...
export default class Ball extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, sizeIdx, colorIdx) {
    ...
    const y = GROUND_Y - 40 - Math.random() * 160;
    ...
    this.radius = size.r;
    this.body.setCircle(size.r, PAD, PAD);
    ...
    this.setVelocity(
      dir * Phaser.Math.Between(BALL_VX_MIN, BALL_VX_MAX),
      -Phaser.Math.Between(BALL_VY_MIN, BALL_VY_MAX)
    );
    this.setAngularVelocity(dir * Phaser.Math.Between(60, 200));
  }
